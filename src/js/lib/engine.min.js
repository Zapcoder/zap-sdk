...
var Zapcoder;!function(t){!function(t){var e=function(){function t(){}return t.register=function(t,e){this.objects[t]=e},t.request=function(t){return t in this.objects?this.objects[t]:null},t.objects={},t}();t.ComponentRegister=e}(t.Registers||(t.Registers={}));t.Registers}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(t){var e=function(){function t(){}return t.register=function(t,e){this.objects[t]=e},t.request=function(t){return t in this.objects?this.objects[t]:null},t.objects={},t}();t.EntityRegister=e}(t.Registers||(t.Registers={}));t.Registers}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){var e=function(){function t(){}return t.images={logo:"/images/engine/logo.png",win:"/images/engine/win.png",lose:"/images/engine/lose.png"},t.spriteSheets={preload:{name:"/images/engine/loading.gif",width:256,height:88}},t}();t.Assets=e}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){var e=function(){function t(){}return t.backgroundColor="#4b5366",t.foregroundRed="#c0433a",t.gameWidth=960,t.gameHeight=640,t.renderer=Phaser.CANVAS,t.messagePoolMax=50,t.eventPoolMax=50,t.boot={loadingFont:{fill:"#FFFFFF",font:"bold 24px Arial"},statusFont:{fill:"#FFFFFF",font:"bold 24px Arial"},totalFont:{fill:"#FFFFFF",font:"bold 24px Arial"},lineHeight:30},t.splash={time:2},t}();t.Data=e}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){var e=function(){function e(e,n,i){this.nextState=null,this.ready=!1,this.config=e,this.container=n,this.state=new t.States.StateManager(this),user=i?new t.Session.User(i):null,this.session=new t.Session.Session(user,this.config._id),this.screen=new t.Util.Screen(this),this.loader=new t.Loaders.LoaderRegister,this.loader.register("audio",new t.Loaders.AudioLoader),this.loader.register("img",new t.Loaders.ImageLoader),this.loader.register("fonts",new t.Loaders.FontLoader),this.game=new Phaser.Game(t.Data.gameWidth,t.Data.gameHeight,t.Data.renderer,n),this.game.state.add("boot",new t.States.Boot(this.config,this),!1),this.game.state.add("win",new t.States.Win(this.config,this),!1),this.game.state.add("lose",new t.States.Lose(this.config,this),!1),this.game.state.add("splash",new t.States.Splash(this.config,this),!0)}return e.prototype.render=function(){this.controller&&this.controller.render()},e.prototype.update=function(){this.controller&&this.controller.update()},e.prototype.uploadData=function(){"undefined"!=typeof this.config.status&&0==this.config.status&&t.Network.uploadSession(this.session)},e.prototype.win=function(){"win"!=this.game.state.current&&(this.uploadData(),this.game.state.start("win"))},e.prototype.screenshot=function(){var t=this.game.canvas.toDataURL();return t},e.prototype.lose=function(){"lose"!=this.game.state.current&&(this.uploadData(),this.game.state.start("lose"))},e.prototype.restart=function(){this.isReady()&&(this.session.score=0,this.session.resetStartTime(),this.state.start(this.config.start))},e.prototype.isReady=function(){return this.ready},e.prototype.setReady=function(t){this.ready=t},e.prototype.shutdown=function(){this.game.sound.stopAll(),this.game.destroy(),this.game=null},e.prototype.boot=function(){var e=t.Data;this.events=new t.Events.EventPool(e.eventPoolMax),this.messages=new t.Messages.MessagePool(e.messagePoolMax)},e}();t.Engine=e}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){var e=function(){function t(){}return t.randomRange=function(t,e){return Math.floor(Math.random()*(e-t+1))+t},t.min=function(t,e){return e>t?t:e},t.max=function(t,e){return t>e?t:e},t.clamp=function(t,e,n){return Math.min(Math.max(n,t),e)},t.PIm2=2*Math.PI,t.PId180=Math.PI/180,t}();t.ZMath=e}(Zapcoder||(Zapcoder={}));var Zap=function(){function t(){}return t.start=function(t,e,n){this.math=Zapcoder.ZMath,this.engine=new Zapcoder.Engine(t,e,n)},t.pause=function(){this.engine.game.paused=!0},t.resume=function(){this.engine.game.paused=!1},t.toggleFullscreen=function(){var t=this.engine.game.stage.scale;t.isFullScreen?t.stopFullScreen():t.startFullscreen()},t.restart=function(){this.engine.restart()},t.components=Zapcoder.Registers.ComponentRegister,t.entities=Zapcoder.Registers.EntityRegister,t}(),Zapcoder;!function(t){var e=function(){function t(){}return t.uploadSession=function(){},t.addScreenshot=function(){},t}();t.Network=e}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(t){var e=function(){function t(){}return t.prototype.load=function(t,e){this.loadObjectData(t,e,null)},t.prototype.loadObjectData=function(t,e,n){null==n&&(n=[]);for(var i in t)t.hasOwnProperty(i)&&(n.push(i),"object"!=typeof t[i]||Array.isArray(t[i])?(console.log(n),e.load.audio(n.join("."),t[i])):this.loadObjectData(t[i],e,n),n.pop())},t}();t.AudioLoader=e}(t.Loaders||(t.Loaders={}));t.Loaders}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(t){var e=function(){function t(){}return t.prototype.load=function(t,e){this.loadObjectData(t,e,null)},t.prototype.loadObjectData=function(t,e,n){null==n&&(n=[]);for(var i in t)t.hasOwnProperty(i)&&(n.push(i),"object"==typeof t[i]&&"undefined"==typeof t[i].image?this.loadObjectData(t[i],e,n):e.load.bitmapFont(n.join("."),t[i].image,t[i].data),n.pop())},t}();t.FontLoader=e}(t.Loaders||(t.Loaders={}));t.Loaders}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(t){var e=function(){function t(){}return t.prototype.load=function(t,e){this.loadObjectData(t,e,null)},t.prototype.loadObjectData=function(t,e,n){null==n&&(n=[]);for(var i in t)if(t.hasOwnProperty(i)){if(n.push(i),"object"==typeof t[i])this.loadObjectData(t[i],e,n);else{var o=t[i];e.load.image(n.join("."),o)}n.pop()}},t}();t.ImageLoader=e}(t.Loaders||(t.Loaders={}));t.Loaders}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(t){var e=function(){function t(){this.loaders={}}return t.prototype.register=function(t,e){this.loaders[t]=e},t.prototype.request=function(t){return this.loaders[t]},t}();t.LoaderRegister=e}(t.Loaders||(t.Loaders={}));t.Loaders}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(t){var e=function(){function t(t,e){this.poolSize=0,this.pool=[],this.poolSize=t;for(var n=0;t>n;n++)this.pool.push(new e)}return t.prototype.create=function(){var t,e;for(t=0,e=this.pool.length;e>t;t+=1)if(!this.pool[t].alive){var n=this.pool[t];return n.init(),n}return null},t.prototype.refresh=function(){var t,e;for(t=0,e=this.pool.length;e>t;t+=1)this.pool[t].alive=!1},t}();t.Pool=e}(t.Util||(t.Util={}));t.Util}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(t){var e=function(){function t(){this.items=[]}return t.prototype.add=function(t){return this.items.unshift(t)},t.prototype.next=function(){var t=this.items.pop();return"undefined"==typeof t?null:t},t}();t.Queue=e}(t.Util||(t.Util={}));t.Util}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(t){var e=function(){function t(t){this.engine=t}return t.prototype.stringToCoord=function(t){switch(t){case"center":return this.engine.game.width>>1;case"right":return this.engine.game.width/100*80;case"left":return this.engine.game.width/100*20;case"middle":return this.engine.game.height>>1;case"bottom":return this.engine.game.height/100*80;case"top":return this.engine.game.height/100*20;default:return t}},t}();t.Screen=e}(t.Util||(t.Util={}));t.Util}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(t){var e=function(){function t(){this.type=null,this.data=null,this.sender=null,this.alive=!1}return t.prototype.init=function(t,e,n){this.type=t,this.data=e,this.sender=n,this.alive=!0},t}();t.Event=e}(t.Events||(t.Events={}));t.Events}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(e){var n=function(){function e(){this.listeners={},this.eventQueue=null,this.nextId=1,this.eventQueue=new t.Util.Queue}return e.prototype.listen=function(t,e){t in this.listeners||(this.listeners[t]=[]);var n=this.nextId++;return this.listeners[t].push({callback:e,id:n}),n},e.prototype.add=function(t){null!=t&&this.eventQueue.add(t)},e.prototype.remove=function(t,e){if(!(t in this.listeners))return!1;var n,i,o=this.listeners[t];for(n=0,i=o.length;i>n;n+=1)if(o[n].id===e)return o.splice(n,1),!0;return!1},e.prototype.update=function(){for(var t=null;t=this.eventQueue.next();)if(t.alive=!1,t.type in this.listeners){var e,n,i=this.listeners[t.type];for(e=0,n=i.length;n>e;e+=1){var o=i[e].callback;o(t.data,t.sender)}}},e}();e.EventDispatcher=n}(t.Events||(t.Events={}));t.Events}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){var n=function(e){function n(n){e.call(this,n,t.Events.Event)}return __extends(n,e),n.prototype.create=function(t,e,n){var i,o;for(i=0,o=this.pool.length;o>i;i+=1)if(!this.pool[i].alive){var s=this.pool[i];return s.init(t,e,n),s}return null},n}(t.Util.Pool);e.EventPool=n}(t.Events||(t.Events={}));t.Events}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(t){var e=function(){function t(){this.type=null,this.sender=null,this.recipientId=null,this.data=null,this.alive=!1}return t.prototype.init=function(t,e,n,i){this.type=t,this.data=e,this.sender=i,this.recipientId=n,this.alive=!0},t}();t.Message=e}(t.Messages||(t.Messages={}));t.Messages}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(e){var n=function(){function e(){this.listeners={},this.messageQueue=null,this.messageQueue=new t.Util.Queue}return e.prototype.listen=function(t,e,n){t in this.listeners||(this.listeners[t]=[]),this.listeners[t].push({callback:n,id:e.id})},e.prototype.add=function(t){null!=t&&this.messageQueue.add(t)},e.prototype.remove=function(t,e){if(!(t in this.listeners))return!1;var n,i,o=this.listeners[t];for(n=0,i=o.length;i>n;n+=1)if(o[n].id===e)return o.splice(n,1),!0;return!1},e.prototype.update=function(){for(var t=null;t=this.messageQueue.next();)if(t.type in this.listeners){var e,n,i=this.listeners[t.type];for(e=0,n=i.length;n>e;e+=1)if(i[e].id===t.recipientId){var o=i[e].callback;o(t.data,t.sender)}t.alive=!1}},e}();e.MessageDispatcher=n}(t.Messages||(t.Messages={}));t.Messages}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){var n=function(e){function n(n){e.call(this,n,t.Messages.Message)}return __extends(n,e),n.prototype.create=function(t,e,n,i){var o,s;for(o=0,s=this.pool.length;s>o;o+=1)if(!this.pool[o].alive){var r=this.pool[o];return r.init(t,e,n,i),r}return null},n}(t.Util.Pool);e.MessagePool=n}(t.Messages||(t.Messages={}));t.Messages}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(t){var e=function(){function t(t,e){this.user=null,this.score=0,this.startTime=0,this.user=t,this.gameId=e}return t.prototype.resetStartTime=function(){this.startTime=(new Date).getTime()/1e3},t.prototype.time=function(){var t=(new Date).getTime()/1e3;return t-this.startTime},t}();t.Session=e}(t.Session||(t.Session={}));t.Session}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(t){var e=function(){function t(t){this.username=null,this.id=null,this.data=null,this.username=t.username,this.id=t.id,this.data=t}return t}();t.User=e}(t.Session||(t.Session={}));t.Session}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(t){var e=function(t){function e(t){this.engine=t}return __extends(e,t),e.prototype.render=function(){this.engine.render()},e.prototype.update=function(){this.engine.update()},e}(Phaser.State);t.State=e}(t.States||(t.States={}));t.States}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){var n=function(e){function n(t,n){e.call(this,n),this.config=t}return __extends(n,e),n.prototype.preload=function(){},n.prototype.create=function(){var e=t.Data.boot,n=this.add.sprite(0,0,"preload");n.x=(this.game.width>>1)-(n.width>>1),n.y=this.game.height/100*80-n.height/2,n.animations.add("loading"),n.animations.play("loading",15,!0);var i=this.add.sprite(0,0,"logo");i.x=(this.game.width>>1)-(i.width>>1),i.y=this.game.height/100*20-(i.height>>1);var o=this.add.text(0,0,"Loaded",e.loadingFont);o.x=(this.game.width>>1)-(o.width>>1),o.y=this.game.height/100*45-(o.height>>1),this.status=this.add.text(0,0,"...",e.statusFont),this.status.x=(this.game.width>>1)-(this.status.width>>1),this.status.y=o.y+e.lineHeight,this.total=this.add.text(0,0,"",e.totalFont),this.total.y=this.status.y+e.lineHeight,this.game.load.image("start",t.Assets.images.start),this.game.load.onFileComplete.add(this.updateStatus,this),this.loadAssets(),this.game.load.start(),this.engine.boot()},n.prototype.update=function(){this.game.load.isLoading||(this.engine.session.resetStartTime(),this.engine.setReady(!0),this.engine.state.start(this.config.start))},n.prototype.loadAssets=function(){for(var t in this.config.assets)if(this.config.assets.hasOwnProperty(t)){var e=this.engine.loader.request(t);e.load(this.config.assets[t],this.game)}},n.prototype.updateStatus=function(e,n,i,o,s){var r=t.Data.boot,a=this.status.y;this.status.destroy(),this.status=this.add.text(0,0,n,r.statusFont),this.status.x=(this.game.width>>1)-(this.status.width>>1),this.status.y=a,a=this.total.y,this.total.destroy(),this.total=this.add.text(0,0,o+"/"+s,r.totalFont),this.total.x=(this.game.width>>1)-(this.total.width>>1),this.total.y=a},n}(t.States.State);e.Boot=n}(t.States||(t.States={}));t.States}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){var n=function(t){function e(e,n){t.call(this,n),this.startTime=0,this.config=e}return __extends(e,t),e.prototype.create=function(){var t=$("#game-over-template").html(),e=Handlebars.compile(t);this.menu=$(e({name:null==Zap.engine.session.user?"You":Zap.engine.session.user.username,score:Zap.engine.session.score,highScore:window.highScore,published:0==Zap.engine.config.status,game_name:Zap.engine.config.name,game_link:"/games/"+Zap.engine.config._id,game_image:Zap.engine.config.thumbnail})),$("body").append(this.menu)},e.prototype.shutdown=function(){this.menu.remove()},e}(t.States.State);e.Lose=n}(t.States||(t.States={}));t.States}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(e){var n=function(){function e(t){this.states={},this.engine=null,this.engine=t}return e.prototype.get=function(e){if(e in this.states)return this.states[e];var n=JSON.parse(JSON.stringify(this.engine.config.states[e]));return this.states[e]=new t.States.TemplateState(n,this.engine),this.engine.game.state.add(e,this.states[e],!1),this.states[e]},e.prototype.start=function(t){t in this.states||this.get(t),this.engine.game.state.start(t)},e}();e.StateManager=n}(t.States||(t.States={}));t.States}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){var n=function(e){function n(t,n){e.call(this,n),this.config=t}return __extends(n,e),n.prototype.create=function(){this.stage.backgroundColor="#000000",Zap.engine.events.refresh(),Zap.engine.game.device.desktop||(this.engine.controller=new t.Input.Controller(this)),this.entities=new t.Entities.EntityManager(this.config.objects,this.config.groups,this.engine.config.objects,this),this.collisions=new t.Collisions.CollisionManager(this.config.collisions,this),null==Zap.engine.config.thumbnail&&window.setTimeout(function(){var e=Zap.engine.screenshot();t.Network.addScreenshot(e)},3e3)},n.prototype.update=function(){e.prototype.update.call(this),this.entities.update(),this.collisions.update()},n.prototype.render=function(){e.prototype.render.call(this),this.entities.render()},n}(t.States.State);e.TemplateState=n}(t.States||(t.States={}));t.States}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){var n=function(e){function n(t,n){e.call(this,n),this.startTime=0,this.config=t}return __extends(n,e),n.prototype.create=function(){var e=this.game.add.sprite(0,0,"logo");e.x=(this.game.width>>1)-(e.width>>1),e.y=(this.game.height>>1)-(e.height>>1),e.alpha=0,this.game.add.tween(e).to({alpha:1},1e3*this.wait-500,Phaser.Easing.Linear.None,!0,0);var n=this.game.add.sprite(0,0,"win");n.x=(this.game.width>>1)-(n.width>>1),n.y=Zap.engine.screen.stringToCoord("bottom"),this.game.stage.backgroundColor=t.Data.backgroundColor;Zap.engine.game.input.onDown.add(function(){Zap.engine.restart()})},n}(t.States.State);e.Win=n}(t.States||(t.States={}));t.States}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){var n=function(t){function e(e,n){t.call(this,n),this.config=e}return __extends(e,t),e.prototype.create=function(){var t=this;this.engine.game.sound.stopAll(),this.engine.game.input.onDown.add(function(){t.engine.restart()})},e}(t.States.State);e.Lose=n}(t.States||(t.States={}));t.States}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){var n=function(e){function n(n,i){e.call(this,i),this.config=null,this.startTime=0,this.wait=0,this.config=n,this.wait=t.Data.splash.time}return __extends(n,e),n.prototype.preload=function(){var e=t.Assets.spriteSheets.preload;this.game.load.spritesheet("preload",e.name,e.width,e.height),this.game.load.image("logo",t.Assets.images.logo),this.game.load.image("win",t.Assets.images.win),this.game.load.image("lose",t.Assets.images.lose)},n.prototype.create=function(){var e=this.game.add.sprite(0,0,"logo");e.x=(this.game.width>>1)-(e.width>>1),e.y=(this.game.height>>1)-(e.height>>1),e.alpha=0,this.game.add.tween(e).to({alpha:1},1e3*this.wait-500,Phaser.Easing.Linear.None,!0,0),this.game.stage.backgroundColor=t.Data.backgroundColor,this.startTime=this.game.time.now,this.game.scale.scaleMode=Phaser.ScaleManager.SHOW_ALL,this.game.scale.pageAlignHorizontally=!0,this.game.scale.pageAlignVertically=!0,this.game.scale.refresh()},n.prototype.update=function(){this.game.time.elapsedSecondsSince(this.startTime)>this.wait&&this.game.state.start("boot")},n}(t.States.State);e.Splash=n}(t.States||(t.States={}));t.States}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(e){var n=function(){function e(t){this.components=[],this.sprite=null,this.config=t,this.id=t.id||null,t.pos&&(t.pos.x=Zap.engine.screen.stringToCoord(t.pos.x),t.pos.y=Zap.engine.screen.stringToCoord(t.pos.y)),this.pos=t.pos||{x:0,y:0}}return e.prototype.init=function(e){this.manager=e,this.events=new t.Events.EventDispatcher;var n,i;for(n=0,i=this.components.length;i>n;n+=1)this.components[n].init(this)},e.prototype.addComponent=function(t){this.components.push(t)},e.prototype.requestComponent=function(t){var e,n;for(e=0,n=this.components.length;n>e;e+=1)if(this.components[e].constructor.name==t)return this.components[e];return null},e.prototype.update=function(){var t,e;for(t=0,e=this.components.length;e>t;t+=1)this.components[t].update();this.events.update()},e.prototype.render=function(){var t,e;for(t=0,e=this.components.length;e>t;t+=1)this.components[t].render()},e.prototype.onCollision=function(t){var e=Zap.engine.events.create("collision",t,this);if(this.events.add(e),t.parent.name){var n=Zap.engine.events.create("collision."+t.parent.name,t,this);this.events.add(n)}},e.prototype.setSprite=function(t){this.sprite=t,t.entity=this},e.prototype.kill=function(){var t,e;for(t=0,e=this.components.length;e>t;t+=1)this.components[t].kill();this.manager.removeEntity(this.id)},e}();e.Entity=n}(t.Entities||(t.Entities={}));t.Entities}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(e){var n=function(){function e(t){this.objectDefinitions={},this.objectDefinitions=t}return e.prototype.build=function(e){var n=new t.Entities.Entity(e),i=null;i="undefined"==typeof this.objectDefinitions[e.type]?e:this.objectDefinitions[e.type];for(var o in i.components)if(i.components.hasOwnProperty(o)){var e=JSON.parse(JSON.stringify(i.components[o]));if(i.global){var s={};for(var r in i.global)s[r]=i.global[r];for(var r in e)s[r]=e[r];e=s}var a=Zap.components.request(e.type),p=new a(e);n.addComponent(p)}return n},e}();e.EntityBuilder=n}(t.Entities||(t.Entities={}));t.Entities}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(e){var n=function(){function e(e){this.builder=new t.Entities.EntityBuilder(e)}return e.prototype.create=function(t){var e=JSON.parse(JSON.stringify(t)),n=Zap.entities.request(e.type);return null!==n?new n(e):this.builder.build(e)},e}();e.EntityFactory=n}(t.Entities||(t.Entities={}));t.Entities}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(e){var n=function(){function e(e,n,i,o){this.entities=[],this.groups={},this.lastId=1,this.state=o,this.factory=new t.Entities.EntityFactory(i),this.events=new t.Events.EventDispatcher,this.messages=new t.Messages.MessageDispatcher,this.createGroups(n),this.createEntities(e)}return e.prototype.createGroups=function(t){if(this.background=this.state.game.add.group(),this.groups.background=this.background,"undefined"!=typeof t){var e,n;for(e=0,n=t.length;n>e;e+=1)this.groups[t[e]]=this.state.game.add.group(),this.groups[t[e]].name=t[e]}this.foreground=this.state.game.add.group(),this.groups.foreground=this.foreground},e.prototype.createEntities=function(t){var e,n;for(e=0,n=t.length;n>e;e+=1){var i=this.factory.create(t[e]);this.addEntity(i)}},e.prototype.update=function(){var t,e;for(t=0,e=this.entities.length;e>t;t+=1)this.entities[t].update();this.messages.update(),this.events.update()},e.prototype.render=function(){var t,e;for(t=0,e=this.entities.length;e>t;t+=1)this.entities[t].render()},e.prototype.addEntity=function(t){this.entities.push(t),t.init(this),null==t.id&&(t.id=this.lastId++)},e.prototype.createEntity=function(t){var e=this.factory.create({type:t});return this.addEntity(e),e},e.prototype.getEntity=function(t){var e,n;for(e=0,n=this.entities.length;n>e;e+=1)if(this.entities[e].id===t)return this.entities[e];return null},e.prototype.removeEntity=function(t){var e,n;for(e=0,n=this.entities.length;n>e;e+=1)this.entities[e].id===t&&this.entities.splice(e,1)},e}();e.EntityManager=n}(t.Entities||(t.Entities={}));t.Entities}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){!function(e){var n=function(t){function e(e){t.call(this,e),this.style=e.style,this.image=e.image,this.pos=e.pos,this.group=e.group||null}return __extends(e,t),e.prototype.init=function(e){t.prototype.init.call(this,e),this.sprite=this.manager.state.add.sprite(this.pos.x,this.pos.y,this.image),this.group&&e.groups[this.group]&&e.groups[this.group].add(this.sprite)},e}(t.Entities.Entity);e.Image=n,Zap.entities.register("Image",t.Entities.Prefabs.Image)}(e.Prefabs||(e.Prefabs={}));e.Prefabs}(t.Entities||(t.Entities={}));t.Entities}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){!function(e){var n=function(t){function e(e){t.call(this,e),this.font=e.font||null,this.size=+e.size||48,this.pos=e.pos||{x:0,y:0}}return __extends(e,t),e.prototype.init=function(e){t.prototype.init.call(this,e),this.text=this.font?Zap.engine.game.add.bitmapText(this.pos.x,this.pos.y,this.font,"",this.size):Zap.engine.game.add.text(this.pos.x,this.pos.y,"",{font:"48px Arial"})},e.prototype.update=function(){this.text.setText("Score: "+Zap.engine.session.score)},e}(t.Entities.Entity);e.ScoreDisplay=n,Zap.entities.register("ScoreDisplay",t.Entities.Prefabs.ScoreDisplay)}(e.Prefabs||(e.Prefabs={}));e.Prefabs}(t.Entities||(t.Entities={}));t.Entities}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(t){!function(t){var e=function(){function t(t){this.config=t}return t.prototype.init=function(t){this.entity=t},t.prototype.update=function(){},t.prototype.render=function(){},t.prototype.kill=function(){},t}();t.Component=e}(t.Components||(t.Components={}));t.Components}(t.Entities||(t.Entities={}));t.Entities}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){!function(e){var n=function(t){function e(t){this.entityData={type:t.entity},this.width=t.width,this.height=t.height,this.spawnOnEvent=t.spawnOnEvent||null}return __extends(e,t),e.prototype.init=function(e){t.prototype.init.call(this,e);var n=this;null!=this.spawnOnEvent&&e.manager.events.listen(this.spawnOnEvent,function(){var t=e.manager.factory.create(n.entityData);t.pos.x=Zap.math.randomRange(e.pos.x,n.width),t.pos.y=Zap.math.randomRange(e.pos.y,n.height),e.manager.addEntity(t)})},e}(t.Entities.Components.Component);e.EntitySpawnRegion=n,Zap.components.register("Zapcoder.Entities.Components.EntitySpawnRegion",t.Entities.Components.EntitySpawnRegion)}(e.Components||(e.Components={}));e.Components}(t.Entities||(t.Entities={}));t.Entities}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){!function(e){var n=function(t){function e(e){t.call(this,e),this.active=!1,this.currentTime=0,this.lastShot=0,this.speed=e.speed,this.shootsEntity=e.entity,this.rate=.001*e.rate}return __extends(e,t),e.prototype.init=function(e){t.prototype.init.call(this,e);var n=this;this.buttonDownId=this.entity.manager.events.listen("controller.button.down",function(){n.active=!0}),this.buttonUpId=this.entity.manager.events.listen("controller.button.up",function(){n.active=!1}),this.collisionId=this.entity.events.listen("collision",function(){e.kill()})},e.prototype.kill=function(){this.entity.manager.events.remove("controller.button.down",this.buttonDownId),this.entity.manager.events.remove("controller.button.up",this.buttonUpId),this.entity.events.remove("collision",this.collisionId),this.active=!1},e.prototype.update=function(){if(this.active||Zap.engine.game.input.keyboard.isDown(32)&&(this.active=!0),this.currentTime+=Zap.engine.game.time.physicsElapsed,this.currentTime-this.lastShot>this.rate&&this.active){var t=this.entity.sprite,e=(t.angle-90)*Zap.math.PId180,n=Math.cos(e),i=Math.sin(e),o=this.entity.manager.factory.create({type:this.shootsEntity,pos:{x:t.x+60*n,y:t.y+60*i}});this.entity.manager.addEntity(o),n*=this.speed,i*=this.speed,o.sprite.body.velocity.x=n,o.sprite.body.velocity.y=i,this.lastShot=this.currentTime}Zap.engine.game.input.keyboard.isDown(32)&&(this.active=!1)},e}(t.Entities.Components.Component);e.Gun=n,Zap.components.register("Zapcoder.Entities.Components.Gun",t.Entities.Components.Gun)}(e.Components||(e.Components={}));e.Components}(t.Entities||(t.Entities={}));t.Entities}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){!function(e){var n=function(t){function e(e){t.call(this,e)}return __extends(e,t),e.prototype.init=function(e){t.prototype.init.call(this,e);Zap.engine.game},e.prototype.update=function(){var t=Zap.engine.game;if(t.input.activePointer.isDown){var e=180*t.physics.angleToPointer(this.entity.sprite)/Math.PI+90;this.entity.sprite.angle=e,t.physics.moveToPointer(this.entity.sprite,200),Phaser.Rectangle.contains(this.entity.sprite.body,t.input.x,t.input.y)&&this.entity.sprite.body.velocity.setTo(0,0)}else this.entity.sprite.body.velocity.setTo(0,0)},e}(t.Entities.Components.Component);e.MouseFollow=n,Zap.components.register("Zapcoder.Entities.Components.MouseFollow",t.Entities.Components.MouseFollow)}(e.Components||(e.Components={}));e.Components}(t.Entities||(t.Entities={}));t.Entities}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){!function(e){var n=function(t){function e(e){t.call(this,e)}return __extends(e,t),e.prototype.init=function(e){t.prototype.init.call(this,e)},e.prototype.update=function(){var t=180*this.entity.manager.state.game.physics.angleToPointer(this.entity.sprite)/Math.PI+90;this.entity.sprite.angle=t},e}(t.Entities.Components.Component);e.MouseLook=n,Zap.components.register("Zapcoder.Entities.Components.MouseLook",t.Entities.Components.MouseLook)}(e.Components||(e.Components={}));e.Components}(t.Entities||(t.Entities={}));t.Entities}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){!function(e){var n=function(t){function e(e){t.call(this,e),this.xd=0,this.yd=0,this.speed=+e.speed,this.left=e.left||null,this.right=e.right||null,this.up=e.up||null,this.down=e.down||null}return __extends(e,t),e.prototype.update=function(){this.xd=0,this.yd=0,Zap.engine.controller?this.updateController():this.updateKeyboard(),this.entity.sprite.body.velocity.x=this.xd,this.entity.sprite.body.velocity.y=this.yd},e.prototype.updateKeyboard=function(){null!==this.left&&Zap.engine.game.input.keyboard.isDown(Phaser.Keyboard[this.left])&&(this.xd-=this.speed),null!==this.right&&Zap.engine.game.input.keyboard.isDown(Phaser.Keyboard[this.right])&&(this.xd+=this.speed),null!==this.up&&Zap.engine.game.input.keyboard.isDown(Phaser.Keyboard[this.up])&&(this.yd-=this.speed),null!==this.down&&Zap.engine.game.input.keyboard.isDown(Phaser.Keyboard[this.down])&&(this.yd+=this.speed)},e.prototype.updateController=function(){var t=Zap.engine.controller.thumbstick;if(t){var e=t.nx,n=t.ny;(0>e&&this.left||e>0&&this.right)&&(this.xd+=this.speed*e),(0>n&&this.up||n>0&&this.down)&&(this.yd+=this.speed*n)}},e}(t.Entities.Components.Component);e.MoveController=n,Zap.components.register("Zapcoder.Entities.Components.MoveController",t.Entities.Components.MoveController)}(e.Components||(e.Components={}));e.Components}(t.Entities||(t.Entities={}));t.Entities}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){!function(e){var n=function(t){function e(e){t.call(this,e),this.img=e.img,this.group=e.group||null}return __extends(e,t),e.prototype.kill=function(){this.sprite.kill()},e.prototype.init=function(e){t.prototype.init.call(this,e),this.sprite=e.manager.state.add.sprite(e.pos.x,e.pos.y,this.img),Zap.engine.game.physics.enable(this.sprite),this.sprite.outOfBoundsKill=this.config.outOfBoundsKill,this.sprite.body.collideWorldBounds=this.config.collideBounds,this.sprite.anchor.setTo(.5,.5),null!==this.group&&(e.manager.groups[this.group].add(this.sprite),this.sprite.group=e.manager.groups[this.group]),e.setSprite(this.sprite)
},e}(t.Entities.Components.Component);e.Sprite=n,Zap.components.register("Zapcoder.Entities.Components.Sprite",t.Entities.Components.Sprite)}(e.Components||(e.Components={}));e.Components}(t.Entities||(t.Entities={}));t.Entities}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(t){var e=function(){function t(t,e){this.collisions=[],this.collisions=t||null,this.state=e}return t.prototype.update=function(){this.checkCollisions()},t.prototype.checkCollisions=function(){var t,e,n=this.collisions,i=this.state.entities.groups;for(t=0,e=n.length;e>t;t+=1){var o=n[t].type;"undefined"==typeof n[t].groups[1]?this.state.game.physics.arcade[o](i[n[t].groups[0]]):this.state.game.physics.arcade[o](i[n[t].groups[0]],i[n[t].groups[1]],this.handleCollision,null,this)}},t.prototype.handleCollision=function(t,e){var n,i,o=t.parent.name+"."+e.parent.name,s=this.collisions;for(n=0,i=s.length;i>n;n+=1){var r=s[n].groups.join(".");o===r&&(t.entity.onCollision(e),e.entity.onCollision(t))}},t}();t.CollisionManager=e}(t.Collisions||(t.Collisions={}));t.Collisions}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(e){var n=function(){function e(e){this.state=e,this.engine=e.engine,this.ctx=e.engine.game.context,this.canvas=e.engine.game.canvas,this.input=e.engine.game.input,this.thumbstick=new t.Input.Thumbstick(this),this.button=new t.Input.Button(this)}return e.prototype.update=function(){this.thumbstick.update(),this.button.update()},e.prototype.render=function(){this.thumbstick.render(),this.button.render()},e}();e.Controller=n}(t.Input||(t.Input={}));t.Input}(Zapcoder||(Zapcoder={}));var Zapcoder;!function(t){!function(t){var e=function(){function t(t){this.active=!1,this.activeInput=null,this.controller=t,this.originX=this.controller.canvas.width/100*10,this.originY=this.controller.canvas.height/100*80;var e=this;this.controller.input.onDown.add(function(t){e.onInputDown(t)}),this.controller.input.onUp.add(function(t){e.onInputUp(t)})}return t.prototype.onInputDown=function(t){this.active=!0,this.activeInput=t},t.prototype.onInputUp=function(t){this.active&&t.id!=this.activeInput.id||(this.active=!1,this.activeInput=null)},t.prototype.update=function(){},t.prototype.render=function(){},t}();t.Touchable=e}(t.Input||(t.Input={}));t.Input}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){var n=function(t){function e(e){t.call(this,e),this.radius=60,this.originX=this.controller.canvas.width/100*90,this.originY=this.controller.canvas.height/100*80}return __extends(e,t),e.prototype.onInputDown=function(t){var e=t.x,n=t.y;if(e<this.originX+this.radius&&e>this.originX-this.radius&&n<this.originY+this.radius&&n>this.originY-this.radius){this.activeInput=t,this.active=!0;var i=Zap.engine.events.create("controller.button.down",null,this);this.controller.state.entities.events.add(i)}},e.prototype.onInputUp=function(e){if(t.prototype.onInputUp.call(this,e),!this.active){var n=Zap.engine.events.create("controller.button.up",null,this);this.controller.state.entities.events.add(n)}},e.prototype.render=function(){this.controller.ctx.fillStyle=this.active?"rgba(192,67,58,0.4)":"rgba(192,67,58,0.25)",this.controller.ctx.beginPath(),this.controller.ctx.arc(this.originX,this.originY,this.radius,0,Zap.math.PIm2),this.controller.ctx.fill()},e}(t.Input.Touchable);e.Button=n}(t.Input||(t.Input={}));t.Input}(Zapcoder||(Zapcoder={}));var __extends=this.__extends||function(t,e){function n(){this.constructor=t}for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i]);n.prototype=e.prototype,t.prototype=new n},Zapcoder;!function(t){!function(e){var n=function(t){function e(){t.apply(this,arguments),this.nx=0,this.ny=0,this.distance=0,this.radius=80,this.range=80}return __extends(e,t),e.prototype.onInputUp=function(e){t.prototype.onInputUp.call(this,e),this.nx=this.ny=this.distance=0},e.prototype.onInputDown=function(t){var e=t.x,n=t.y;e<this.originX+this.radius&&e>this.originX-this.radius&&n<this.originY+this.radius&&n>this.originY-this.radius&&(this.activeInput=t,this.active=!0)},e.prototype.update=function(){if(this.active){var t=this.activeInput.x,e=this.activeInput.y,n=t-this.originX,i=e-this.originY,o=Math.sqrt(n*n+i*i);this.nx=n/o,this.ny=i/o,this.distance=Zap.math.min(this.range,o)}},e.prototype.render=function(){this.renderBase(),this.renderPad()},e.prototype.renderBase=function(){this.controller.ctx.fillStyle=this.active?"rgba(192,67,58, 0.4)":"rgba(192,67,58, 0.25)",this.controller.ctx.beginPath(),this.controller.ctx.arc(this.originX,this.originY,this.radius,0,Zap.math.PIm2),this.controller.ctx.fill()},e.prototype.renderPad=function(){this.controller.ctx.fillStyle=this.active?"rgba(192,67,58,0.4)":"rgba(192,67,58,0.25)",this.controller.ctx.beginPath();var t=this.originX+this.nx*this.distance,e=this.originY+this.ny*this.distance;this.controller.ctx.arc(t,e,this.radius-20,0,Zap.math.PIm2),this.controller.ctx.fill()},e}(t.Input.Touchable);e.Thumbstick=n}(t.Input||(t.Input={}));t.Input}(Zapcoder||(Zapcoder={}));