    ...
    */
    var Engine = (function () {
        ...
        Engine.prototype.screenshot = function () {
            var data = this.game.stage.canvas.toDataURL();
            return data;
        };
    ...
    (function (Entities) {
        var Entity = (function () {
            ...
            Entity.prototype.onCollision = function (sprite) {
                ...
                this.events.add(e);
                if (sprite.group.name) {
                    var ed = Zap.engine.events.create('collision.' + sprite.group.name, sprite, this);
                    this.events.add(ed);
                }
            };
        ...
        (function (Prefabs) {
            var ScoreDisplay = (function (_super) {
                ...
                ScoreDisplay.prototype.init = function (manager) {
                    ...
                    if (this.style)
                        this.text = Zap.engine.game.add.bitmapText(this.pos.x, this.pos.y, '', this.style);
                    else
            ...
            CollisionManager.prototype.checkCollisions = function () {
                ...
                for (i = 0, l = collisions.length; i < l; i += 1) {
                    ...
                    if (typeof collisions[i].groups[1] === 'undefined') {
                        this.state.game.physics[type](groups[collisions[i].groups[0]]);
                    } else {
                        this.state.game.physics[type](groups[collisions[i].groups[0]], groups[collisions[i].groups[1]], this.handleCollision, null, this);
                    }
                }
            };

            CollisionManager.prototype.handleCollision = function (a, b) {
                var i, l, currentCollisionName = a.group.name + '.' + b.group.name, collisions = this.collisions;
