        ...
        (function (Components) {
            var Gun = (function (_super) {
                ...
                Gun.prototype.update = function () {
                    ...
                    if (this.currentTime - this.lastShot > this.rate && this.active) {
        ...
        (function (Components) {
            var MoveController = (function (_super) {
                ...
                MoveController.prototype.updateController = function () {
                    var joystick = Zap.engine.controller.thumbstick;
    ...
    (function (Input) {
        var Controller = (function () {
            function Controller(state) {
                ...
                this.thumbstick = new Zapcoder.Input.Thumbstick(this);
                this.button = new Zapcoder.Input.Button(this);
            }
            Controller.prototype.update = function () {
                this.thumbstick.update();
                this.button.update();
            };

            Controller.prototype.render = function () {
                this.thumbstick.render();
                this.button.render();
            };
            return Controller;
        })();
    ...
    (function (Input) {
        var Touchable = (function () {
            function Touchable(controller) {
                ...
                this.originX = (this.controller.canvas.width / 100) * 10;
                this.originY = (this.controller.canvas.height / 100) * 80;
    ...
    (function (Input) {
        var Button = (function (_super) {
            ...
            function Button(controller) {
                ...
                this.radius = 60;
                this.originX = (this.controller.canvas.width / 100) * 90;
                this.originY = (this.controller.canvas.height / 100) * 80;
            }
