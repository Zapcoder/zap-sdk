        ...
        Engine.prototype.lose = function () {
            if (this.game.state.current != 'lose') {
                if (!this.loseDelay) {
                    ...
                    this.loseDelay = window.setTimeout(function () {
                        self.game.paused = false;
                        console.log('lose now go');
                        self.loseDelay = null;
                        self.uploadData();
        ...
        (function (Components) {
            var Gun = (function (_super) {
                ...
                function Gun(config) {
                    ...
                    this.soundAsset = config.sound || null;
                }
                Gun.prototype.init = function (entity) {
                    ...
                    if (this.soundAsset) {
                        this.sound = Zap.engine.game.add.audio(this.soundAsset);
                    }
                };
                ...
                Gun.prototype.shoot = function () {
                    if (this.currentTime - this.lastShot > this.rate) {
                        ...
                        bullet.sprite.angle = this.entity.sprite.angle;
